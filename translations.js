  ...
  en: {
    common: {
      ...
      footer: {
        ...
        badge: "Protecting Kenyan Transactions",
    ...
    about: {
      ...
      complianceHeading: "How We Protect Your Money",
      complianceText: "Every transaction is secured with cryptographically hashed access tokens, verified M-PESA payment confirmations, and strict data protections - see our Compliance page for the full technical detail on how your funds and data are actually protected.",
      feature1Title: "Hashed Access Tokens",
      feature1Desc: "Every transaction link uses a one-way cryptographic token, never a guessable ID",
      feature2Title: "Verified Payments",
      feature2Desc: "Every M-PESA confirmation is cross-checked against the transaction before funds are marked secured",
      feature3Title: "M\u2011PESA Integration",
      feature3Desc: "Built on Safaricom's official Daraja API for payment and payout",
      feature4Title: "Direct Support",
      feature4Desc: "Real responses from a real person, not a ticket queue",
      stat1Label: "Transactions Protected",
      stat2Label: "Secured via M-PESA",
      stat3Label: "Dispute-Free Rate",
      stat4Label: "Target Release Time"
    },
  ...
  sw: {
    common: {
      ...
      footer: {
        ...
        badge: "Tunalinda Miamala ya Kenya",
    ...
    about: {
      ...
      complianceHeading: "Jinsi Tunavyolinda Fedha Zako",
      complianceText: "Kila muamala unalindwa kwa tokeni za ufikiaji zilizosimbwa, uthibitisho wa malipo ya M-PESA uliohakikiwa, na ulinzi mkali wa data - tembelea ukurasa wetu wa Uzingatiaji kwa maelezo kamili ya kiufundi jinsi fedha na data yako inavyolindwa kwa uhalisia.",
      feature1Title: "Tokeni za Ufikiaji Zilizosimbwa",
      feature1Desc: "Kila kiungo cha muamala kinatumia tokeni ya njia moja iliyosimbwa, si nambari inayoweza kubashiriwa",
      feature2Title: "Malipo Yaliyothibitishwa",
      feature2Desc: "Kila uthibitisho wa M-PESA unalinganishwa na muamala kabla fedha hazijawekwa alama ya kulindwa",
      feature3Title: "Muunganiko wa M\u2011PESA",
      feature3Desc: "Imejengwa kwa API rasmi ya Daraja ya Safaricom kwa malipo na utoaji",
      feature4Title: "Msaada wa Moja kwa Moja",
      feature4Desc: "Majibu halisi kutoka kwa mtu halisi, si foleni ya tiketi",
      stat1Label: "Miamala Iliyolindwa",
      stat2Label: "Ilivyolindwa kupitia M-PESA",
      stat3Label: "Kiwango Kisicho na Mgogoro",
      stat4Label: "Muda Unaolengwa wa Kutolewa"
    },
